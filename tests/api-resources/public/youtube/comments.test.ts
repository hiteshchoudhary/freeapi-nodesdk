...
describe('resource comments', () => {
  test('retrieve', async () => {
    const responsePromise = client.public.youtube.comments.retrieve('cv-6bAeYsOY');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.public.youtube.comments.retrieve('cv-6bAeYsOY', { path: '/_stainless_unknown_path' }),
