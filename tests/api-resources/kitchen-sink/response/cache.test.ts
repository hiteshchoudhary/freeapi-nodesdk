...
describe('resource cache', () => {
  test('retrieve', async () => {
    const responsePromise = client.kitchenSink.response.cache.retrieve('120', 'public');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.kitchenSink.response.cache.retrieve('120', 'public', { path: '/_stainless_unknown_path' }),
