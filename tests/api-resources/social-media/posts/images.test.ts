...
describe('resource images', () => {
  test('remove', async () => {
    const responsePromise = client.socialMedia.posts.images.remove(
      '64a3e3bc9d02a1e3d365f06a',
      '64a3e45c9d02a1e3d365f08d',
    );
  ...
  test('remove: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.socialMedia.posts.images.remove('64a3e3bc9d02a1e3d365f06a', '64a3e45c9d02a1e3d365f08d', {
