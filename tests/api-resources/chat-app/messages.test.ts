...
describe('resource messages', () => {
  test('delete', async () => {
    const responsePromise = client.chatApp.messages.delete(
      '64ce7766307617f3a412b803',
      '660c01cef9b076f062b161a8',
    );
  ...
  test('delete: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.chatApp.messages.delete('64ce7766307617f3a412b803', '660c01cef9b076f062b161a8', {
